...
const DashApplication: React.FC = () => {
  ...
  const dashboard = useResource(() => tun.get(`/uk-ewsgit-dash/dashboard`, "json", z.object({
                                                                                              header: z.object({
  ...
  return (<div
          ...
          style={dashboard.background.type === "color" ? { backgroundColor: dashboard.background.value } : dashboard.background.type === "linearGradient" ? { backgroundImage: `linear-gradient(${dashboard.background.value})` } : { backgroundImage: `url(${tun.baseUrl + "/uk-ewsgit-dash/backgroundImage"})` }}
      >
        <UKFlex
        ...
        >
          <UKHeading
              ...
              text={dashboard.header.welcomeMessage.replace(
                  `%username%`, `${dashboard.user.forename} ${dashboard.user.surname}`)}
          />
        </UKFlex>
        {isWidgetEditMode ? (<>
              <UKCard
            ...
            >
              <UKCarousel
                  ...
                  items={[
                    {
                      element: (<div className={styles.widgetGrid}>
                            <UKCard>Item</UKCard>
                            <UKCard>Item</UKCard>
                            <UKCard>Item</UKCard>
                            <UKCard>Item</UKCard>
